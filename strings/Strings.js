const strings = Object.freeze({
  path: {
    ...
    REDIRECT_LOGIN: "https://localhost:4000/logowanie",
    REFERER_LOGIN: "https://localhost:4000/logowanie",
    REFERER_SIGNUP: "https://localhost:4000/rejestracja",
    REFERER_CONTACT: "https://localhost:4000/",
    SERVICE_EMAIL: "paul.del.priore29@gmail.com",
    ORIGIN_FRONT: "https://localhost:4000",
  },
  port: 4000,
  request: {
    HEADER: "x-auth",
